...
if is_available "toggleterm.nvim" then
  ...
  local function superpy()
    local fullpath = vim.api.nvim_buf_get_name(0)
    toggle_term_cmd { cmd = 'ipython -i ' .. fullpath, hidden = true }
  end

  maps.n["<leader>tsp"] = { superpy, desc = "ToggleTerm super python" }
  maps.n["<leader>tp"] = { function() toggle_term_cmd "ipython" end, desc = "ToggleTerm python" }
