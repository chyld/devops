...
sudo apt-get update
sudo apt-get install -y libltdl7 postgresql-client git vim tree tmux htop curl
...
ln -s ~/Code/devops/dotfiles/ubuntu/ubuntu-17.10/.tmux.conf .
ln -s ~/Code/devops/dotfiles/ubuntu/ubuntu-17.10/.vimrc .
ln -s ~/Code/devops/dotfiles/ubuntu/ubuntu-17.10/.gitconfig .

git clone https://github.com/VundleVim/Vundle.vim.git ~/.vim/bundle/Vundle.vim
vim +PluginInstall +qall

ln -s ~/Code/devops/dotfiles/ubuntu/ubuntu-17.10/.bash_aliases .
ln -s ~/Code/devops/dotfiles/ubuntu/ubuntu-17.10/.bash_profile .
ln -s ~/Code/devops/dotfiles/ubuntu/ubuntu-17.10/.bash_colors .
